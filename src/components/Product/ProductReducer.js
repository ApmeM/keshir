...
const FETCH_PRODUCT_REQUEST = 'PRODUCT/FETCH_REQUEST';
const FETCH_PRODUCT_SUCCESS = 'PRODUCT/FETCH_SUCCESS';
const FETCH_PRODUCT_FAILED = 'PRODUCT/FETCH_FAILED';
const SWITCH_PRODUCT_VARIANT = 'PRODUCT/SWITCH_VARIANT';
